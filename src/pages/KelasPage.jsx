    ...
    <div className="kelas-page">
      <div className="kelas min-vh-100">
        <Container>
          <Row>
            <Col>
              <h1 className="fw-bold text-center animate__animated animate__fadeInUp">Semua Paketan</h1>
              <p className="text-center animate__animated animate__fadeInUp">Kualitas trand, harga best friends.</p>
            </Col>
          </Row>
